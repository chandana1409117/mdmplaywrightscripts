...
- Name: Tests\Login\Login.spec.js >> Authentication Tests >> Invalid credentials
- Location: Scripts\Tests\Login\Login.spec.js:9:9
...
- generic [ref=e2]:
        ...
        - generic [ref=e28]:
          - generic [ref=e29]:
            ...
            - generic [ref=e33]:
              ...
              - generic [ref=e35]:
                - textbox [ref=e36]: invalidpassword
  ...
  - status [ref=e60]: Account is locked due to multiple failed login attempts.
```
